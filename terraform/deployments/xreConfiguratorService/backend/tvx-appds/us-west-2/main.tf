terraform {
  backend "s3" {
    ...
    key    = "coast/tvx-appds/dataService/configds/us-west-2/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}
...
module "prod-west-configds" {
  ...
  security_groups             = ["sg-e5cbb89f", "sg-8c46e3f0", "sg-0d7f5675616baa4fe", "sg-06e3db685a3dd2d86"]
