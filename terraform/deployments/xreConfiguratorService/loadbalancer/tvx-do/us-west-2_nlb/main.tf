terraform {
  backend "s3" {
    ...
    key    = "coast/ci/nlb/configds/us-west-2/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}

module "ci-west-configds-nlb" {
  source                           = "../../../../../modules/nlb"
...
#Workspace naming format is xreconfigds_nlb_dw_(base date)_(iteration number)