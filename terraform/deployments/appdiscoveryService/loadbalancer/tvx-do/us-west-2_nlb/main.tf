terraform {
  backend "s3" {
    ...
    key    = "coast/ci/nlb/appdiscoveryService/us-west-2/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}

module "ci-west-appdiscoveryService-nlb" {
  source                           = "../../../../../modules/nlb"
...
#Workspace naming format is adsds_nlb_dw_(base date)_(iteration number)