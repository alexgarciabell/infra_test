...
module "ci-east-adsds" {
  ...
  security_groups              = ["sg-88b78bed", "sg-a8e1eccd", "sg-49fcba2c", "sg-0a51f065c8a8876ef"]
...
#Workspace naming format is adsds_lb_de_(base date)_(iteration number)