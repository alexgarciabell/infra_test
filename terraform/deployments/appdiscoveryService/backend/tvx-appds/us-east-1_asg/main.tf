terraform {
  backend "s3" {
    ...
    key    = "coast/tvx-appds/dataService/adsds/us-east-1-asg/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}

module "prod-autoscaling-east-adsds" {
  source                      = "../../../../../modules/autoscaling/with_no_nlb"
  aws_instance_type           = "c5.xlarge"
  aws_security_groups         = ["sg-0f6cbb70ed4aa5608", "sg-39f23949", "sg-081a197d79f6858d5"]
