terraform {
  backend "s3" {
    ...
    key    = "coast/prod/hatsmaker/cmTagDataService/us-west-2/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}

module "prod-west-cmtagds" {
...
#tag-service-haproxy-west - sg-06f4d98acf6e3d475
  security_groups              = ["sg-f545c58f", "sg-e5cbb89f", "sg-affd71d5", "sg-0a84b276c07a06611", "sg-06f4d98acf6e3d475"]
