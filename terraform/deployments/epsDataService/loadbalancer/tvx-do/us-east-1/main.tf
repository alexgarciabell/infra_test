terraform {
  backend "s3" {
    ...
    key    = "coast/staging/hatsmaker/epsDataService/us-east-1/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}
...
module "ci-east-epsds" {
  ...
  security_groups              = ["sg-74b49806","sg-13387267","sg-13387267"]
...
#Workspace naming format is epsds_lb_de_(base date)_(iteration number)