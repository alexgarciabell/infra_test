terraform {
  backend "s3" {
    ...
    key    = "coast/tvx-appds/dataService/epsds/us-east-2-asg/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}

module "prod-autoscaling-ohio-epsds" {

  source                      = "../../../../../modules/autoscaling/with_no_nlb"
  aws_instance_type           = "c5.xlarge"
  aws_security_groups         = ["sg-6ed1db05", "sg-0fc24c7b768123161", "sg-0a34b7dc001aaae06", "sg-0e6b38d48e65f08f3"]
