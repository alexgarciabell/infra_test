terraform {
  backend "s3" {
    ...
    key    = "coast/staging/hatsmaker/epsadmin/us-west-2/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}
...
#Workspace naming format is epsadmin_lb_dw_(base date)_(iteration number)