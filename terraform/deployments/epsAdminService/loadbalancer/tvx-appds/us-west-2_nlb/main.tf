terraform {
  backend "s3" {
    ...
    key    = "coast/prod/nlb/epsadmin/us-west-2/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}

module "prod-west-epsadmin-nlb" {
  source                           = "../../../../../modules/nlb"
...
#Workspace naming format is epsadmin_nlb_aw_(base date)_(iteration number)