terraform {
  backend "s3" {
    ...
    key    = "coast/prod/hatsmaker/epsadmin/us-west-2/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}
...
module "prod-west-epsadmin" {
  ...
  security_groups              = ["sg-affd71d5", "sg-695f640d", "sg-50ab4a37", "sg-a2c366de", "sg-02939504d7112a332"]
  ...
  hats_id                      = "APPDS_AW_EPSADMIN_PROD"
...
#Workspace naming format is epsadmin_lb_aw_(base date)_(iteration number)