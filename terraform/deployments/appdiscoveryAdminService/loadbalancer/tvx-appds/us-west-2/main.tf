terraform {
  backend "s3" {
    ...
    key    = "coast/prod/hatsmaker/appdiscoveryAdminService/us-west-2/tfstate/terraform.tfstate"
    region = "us-west-2"
  }
}
...
module "prod-west-adsadmin" {
  ...
  security_groups              = ["sg-e5cbb89f", "sg-affd71d5", "sg-695f640d", "sg-e4dadb82", "sg-0c52413f6f931c854"]
  ...
  hats_id                      = "APPDS_AW_ADSADMIN_PROD"
...
#Workspace naming format is adsadmin_lb_aw_(base date)_(iteration number)