...
locals {
  ami_name = "icfar-epsds-${legacy_isotime("02-Jan-2006-03-04-05")}"
}
...
source "amazon-ebs" "epsDataService" {
  ...
  snapshot_tags = {
    ...
    elasticsearch       = "true"
    notes               = "Service AMI For EPS DS - Snapshot"
    opens               = "true"
...
build {
  ...
  provisioner "ansible-local" {
    ...
    role_paths      = ["../../ansible/roles/java", "../../ansible/roles/jetty", "../../ansible/roles/epsDataService", "../../ansible/roles/eracent-installer"]
  }

  post-processor "manifest" {
    output     = "epsds_result_${legacy_isotime("02-Jan-2006")}.json"
    strip_path = true
  }
}
