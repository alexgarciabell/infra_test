...
if [[ $# -lt 2 ]]; then
  echo "usage: customSplitEvaluator.sh <version> <account> <dry_run OR real_run>"
...
echo "Building customSplitEvaluator Packer template."
...
../configs/customSplitEvaluator.json"
else
