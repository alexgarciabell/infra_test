...
if [[ $# -lt 2 ]]; then
  echo "usage: appdiscoveryAdminService.sh <version> <account> <dry_run OR real_run>"
...
echo "Building appdiscoveryAdminService Packer template."
...
../configs/appdiscoveryAdminService.json"
else
