...
if [[ $# -lt 2 ]]; then
  echo "usage: appdiscoveryService.sh <version> <account> <dry_run OR real_run>"
...
echo "Building appdiscoveryService Packer template."
...
../configs/appdiscoveryService.json"
else
