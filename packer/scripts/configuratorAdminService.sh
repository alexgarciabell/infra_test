...
if [[ $# -lt 2 ]]; then
  echo "usage: configuratorAdminService.sh <version> <account> <dry_run OR real_run>"
...
echo "Building configuratorAdminService Packer template."
...
../configs/configuratorAdminService.json"
else
